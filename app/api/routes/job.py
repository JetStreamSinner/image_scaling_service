...
from app.models.schemas.job_info import ScaleImage, Image

job = APIRouter()


@job.post("/do_job", response_model=Image)
def do_job_handler(job_info: ScaleImage):
    ...
    return Image(image_data=encoded_image)
